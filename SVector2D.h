...
inline double operator*(const SVector2D &lhs, const SVector2D &rhs)
{
	double r;
...
//--------------------------------------------------------------------
inline double Vec2DLength( SVector2D v)
{
...
inline SVector2D Vec2DNormalize3(SVector2D v)
{
    double vector_length = Vec2DLength(v);
	SVector2D r;
	r.x = v.x / vector_length;
	r.y = v.y / vector_length;

	return r;
}


inline SVector2D Vec2DNormalize2(SVector2D v,double normal)
{
